...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=682749926ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=coppelomnicanal&table=task">`coppelomnicanal`.`task`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=coppelomnicanal&table=user">`coppelomnicanal`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=coppelomnicanal&table=area">`coppelomnicanal`.`area`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=coppel&table=products">`coppel`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=coppel&table=class">`coppel`.`class`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=coppel&table=family">`coppel`.`family`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=coppel&table=department">`coppel`.`department`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sistema&table=empleados">`sistema`.`empleados`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=libreria&table=libreria_libro">`libreria`.`libreria_libro`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="422e2f4623577a26573d4f6172613d51">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="coppel" targettable="class">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `class`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="coppelomnicanal" targettable="area">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `coppelomnicanal`.`area` ( `id_area` INT(3) NOT NULL AUTO_INCREMENT ,  `area_description` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`id_area`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="coppel" targettable="class">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `area`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="coppelomnicanal" targettable="area">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `area` (`id_area`, `area_description`) VALUES (NULL, &#039;Desarrollo IOS&#039;), (NULL, &#039;Desarrollo Android&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="coppelomnicanal" targettable="area">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `area` (`id_area`, `area_description`) VALUES (NULL, &#039;Pruebas&#039;), (NULL, &#039;Desarrollo Web&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="coppelomnicanal" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `coppelomnicanal`.`user` ( `id_user` INT(3) NOT NULL AUTO_INCREMENT ,  `user_name` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`id_user`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="coppelomnicanal" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `user` (`id_user`, `user_name`, `id_area`) VALUES (NULL, &#039;Juan Manuel Lopez&#039;, &#039;1&#039;), (NULL, &#039;Mario Garcia&#039;, &#039;1&#039;), (NULL, &#039;Adriana Dominguez&#039;, &#039;2&#039;), (NULL, &#039;Lupita Martinez&#039;, &#039;2&#039;), (NULL, &#039;Raul Hernandez&#039;, &#039;3&#039;), (NULL, &#039;Francisco Almazan&#039;, &#039;3&#039;), (NULL, &#039;Pedro Garcia&#039;, &#039;4&#039;), (NULL, &#039;Daniela Figueroa&#039;, &#039;4&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="coppelomnicanal" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="coppel" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="coppelomnicanal" targettable="task">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `coppelomnicanal`.`task` ( `id_task` INT(3) NOT NULL AUTO_INCREMENT ,  `task_description` VARCHAR(100) NOT NULL ,  `id_area` INT(3) NOT NULL ,  `id_user` INT(3) NOT NULL ,  `registration_date` DATE NOT NULL ,  `finish_date` DATE NOT NULL ,  `status` INT(1) NOT NULL ,    PRIMARY KEY  (`id_task`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="coppelomnicanal" targettable="task">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `task`</span>
                        </div>
                                            <div class="message history collapsed hide"
            ...
            Queried time
                            ...
                            <span class="query">CREATE USER &#039;userdb&#039;@&#039;localhost&#039; IDENTIFIED VIA mysql_native_password USING &#039;***&#039;;GRANT USAGE ON *.* TO &#039;userdb&#039;@&#039;localhost&#039; REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;GRANT ALL PRIVILEGES ON `coppelomnicanal`.* TO &#039;userdb&#039;@&#039;localhost&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="coppelomnicanal" targettable="area">
                            <div class="action_content">
